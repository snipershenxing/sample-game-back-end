...
@SpringBootTest
public class GameServiceTest2 extends DropTokenTests {
    ...
    public void createNewGameTest() throws ExecutionException, InterruptedException {
        ...
        for (int i = 0; i < 10; i++){
            ...
            Assert.assertEquals("gameId"+(i+11), rstOfCreatingGame.get());
            System.out.println("-----------------------------------------");
        ...
        String testGameId = "gameId11";
        JSONObject rstOfGettingGameState = gameservice.getStateOfGameById(testGameId);
        System.out.println("-----------------------------------------");
        System.out.println(rstOfGettingGameState);
        System.out.println("-----------------------------------------");

        String rstOfPostMove = gameservice.postMove("gameId11", "Ethan", 1);
        System.out.println("-----------------------------------------");
        System.out.println(rstOfPostMove);
        System.out.println("-----------------------------------------");

        Collection<Move> rstOfGettingMoveList = gameservice.getListOfMove("gameId11");
        System.out.println("-----------------------------------------");
        System.out.println(rstOfGettingMoveList);
        System.out.println("-----------------------------------------");

        Move rstOfGettingMove = gameservice.getMove("gameId11", 1);
        System.out.println("-----------------------------------------");
        System.out.println(rstOfGettingMove);
        System.out.println("-----------------------------------------");

        gameservice.playerQuit("gameId11", "Ethan");
        System.out.println("-----------------------------------------");
        System.out.println(gameservice.getStateOfGameById("gameId11"));
        System.out.println("-----------------------------------------");
    }
